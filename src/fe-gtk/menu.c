...
{
	fe_open_url ("http://arabicon.readthedocs.org");
}
...
#ifdef HAVE_GTK_MAC
		/* We want ARABICON to be the app menu, not including Quit or ARABICON itself */
