...
#define DBUS_SERVICE "org.arabicon.service"
#define DBUS_REMOTE "/org/arabicon/Remote"
#define DBUS_REMOTE_CONNECTION_INTERFACE "org.arabicon.connection"
#define DBUS_REMOTE_PLUGIN_INTERFACE "org.arabicon.plugin"
		 ...
		 gpointer user_data)
{
	...
	if (hook_id == command_id) {
		...
		/* Now if you write "/test blah" again in the ARABICON window
...
main (int argc, char **argv)
{
	...
	/* Now you can write on the ARABICON windows: "/test arg1 arg2 ..." */
