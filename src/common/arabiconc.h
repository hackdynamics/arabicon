...
extern struct arabiconprefs prefs;

extern int arabicon_is_quitting;
...
void arabicon_reinit_timers (void);
...
void lag_check (void);
void arabicon_exit (void);
void arabicon_exec (const char *cmd);
