...
int arabicon_open_file (const char *file, int flags, int mode, int xof_flags);
FILE *arabicon_fopen_file (const char *file, const char *mode, int xof_flags);
...
#define P_OFFSET(field) STRUCT_OFFSET_STR(struct arabiconprefs, field),sizeof(prefs.field)
#define P_OFFSETNL(field) STRUCT_OFFSET_STR(struct arabiconprefs, field)
#define P_OFFINT(field) STRUCT_OFFSET_INT(struct arabiconprefs, field),0
#define P_OFFINTNL(field) STRUCT_OFFSET_INT(struct arabiconprefs, field)
